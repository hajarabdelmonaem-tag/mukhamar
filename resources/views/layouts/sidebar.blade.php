    ...
    <div class="pt-8 pb-7 flex items-center gap-2" :class="(!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen) ? 'justify-center' : 'justify-between'">
        <a href="/">
            <div class="hidden [.sidebar-expanded_&]:block">
                <img class="dark:hidden" src="/images/logo/logo.svg" alt="{{ __('admin.logo') }}" width="150" height="40" />
                <img class="hidden dark:block" src="/images/logo/logo-dark.svg" alt="{{ __('admin.logo') }}" width="150" height="40" />
            </div>
            <img class="block [.sidebar-expanded_&]:hidden" src="/images/logo/logo-icon.svg" alt="{{ __('admin.logo') }}" width="32" height="32" />
        </a>
    </div>
